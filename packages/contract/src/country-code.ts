...
/**
 * ISO 3166-1 alpha-2 codes. Kept as a frozen set so API validation and mobile
 * pickers share one allowlist.
 */
...
export const countryCodeSchema = z
  ...
  .refine(isValidCountryCode, { message: 'Unrecognised country code' });
